...
import http_api.HttpTaskServer;
...
class HttpTaskServerTest {
    ...
    private static Gson gson = new GsonBuilder().registerTypeAdapter(Instant.class, new InstantTime()).create();
    ...
    void shouldGetTasks() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("Name1", "Des1", TaskStatus.NEW, Instant.now(), 1);
    ...
    void shouldGetEpics() {
        ...
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 2);
    ...
    void shouldGetSubtasksTest() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 3);
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                epic.setId(epicId);
                Subtask subtask = new Subtask("Name1", "Des1", TaskStatus.NEW, epic.getId()
                        , Instant.now(), 4);
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void shouldGetTaskById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("Name1", "Des1", TaskStatus.NEW, Instant.now(), 5);
    ...
    void shouldGetEpicById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 6);
    ...
    void shouldGetSubtaskById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 7);
    ...
    void shouldUpdateTask() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("Name1", "Des1", TaskStatus.NEW, Instant.now(), 9);
    ...
    void shouldUpdateEpic() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 10);
    ...
    void shouldUpdateSubtask() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 11);
    ...
    void shouldDeleteTasks() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("Name1", "Des1", TaskStatus.NEW, Instant.now(), 13);
    ...
    void shouldDeleteEpics() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 14);
    ...
    void shouldDeleteSubtasks() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 15);
    ...
    void shouldDeleteTaskById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("Name1", "Des1", TaskStatus.NEW, Instant.now(), 17);
    ...
    void shouldDeleteEpicById() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(EPIC_BASE_URL);
        Epic epic = new Epic("Name1", "Des1", TaskStatus.NEW, Instant.now(), 18);
