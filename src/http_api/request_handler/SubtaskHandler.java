package http_api.request_handler;
...
public class SubtaskHandler implements HttpHandler {
    private final Gson gson = new GsonBuilder().registerTypeAdapter(Instant.class, new InstantTime()).create();
            ...
            case "POST":
                ...
                try {
                    ...
                    if (taskManager.getSubtask(id) != null) {
                        ...
                        Subtask subtaskCreated = taskManager.addNewSubtask(subtask);
